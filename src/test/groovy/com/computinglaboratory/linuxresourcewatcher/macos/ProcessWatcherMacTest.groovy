...
import com.computinglaboratory.linuxresourcewatcher.watchers.macos.ProcessWatcherMac
...
class ProcessWatcherMacTest extends Specification {
    ...
    def "getProcessResidentSetSizeMemory rise exception when process does not exist"() {
        ...
        then:
        thrown com.computinglaboratory.linuxresourcewatcher.exceptions.NoProcessFoundException
    }
